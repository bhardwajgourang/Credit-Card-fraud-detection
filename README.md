...
(Or manually: numpy, pandas, matplotlib, seaborn, scikit-learn)
...
⚠️ Note: Due to its large size, creditcard.csv is included in .gitignore.
Download it manually and place it in the project directory.
...
Train supervised models (Logistic Regression, XGBoost)

Handle class imbalance using SMOTE / undersampling

Build a Flask or Streamlit web app

Deploy model using Docker or AWS
